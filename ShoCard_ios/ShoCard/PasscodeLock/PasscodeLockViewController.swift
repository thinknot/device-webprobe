...
public class PasscodeLockViewController: UIViewController, PasscodeLockTypeDelegate {
    ...
    public enum LockState {
        ...
        func getState() -> PasscodeLockStateType {
            ...
            switch self {
            case .InitPasscode:  return InitPasscodeState()
    ...
    public override func viewWillDisappear(animated:Bool) {
        ...
        dismissDelegate?.childDismissed()
    }
    ...
    internal func dismissPasscodeLock(lock: PasscodeLockType) {
        ...
        notificationCenter.postNotificationName("PasscodeLockDidDismissPasscodeLock", object: nil)
